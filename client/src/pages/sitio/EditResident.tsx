  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const resData = residentRes.data;
        setFormData({
          ...
          civil_status: resData.civil_status,
          occupation: resData.occupation || '',
          school_attainment: resData.school_attainment || '',
          skills: resData.skills || '',
          blood_type: resData.blood_type || '',
          is_4ps: Boolean(resData.is_4ps),
          is_pwd: Boolean(resData.is_pwd),
          is_solo_parent: Boolean(resData.is_solo_parent),
          is_senior_citizen: Boolean(resData.is_senior_citizen)
        });
      } catch (error) {
        console.error("Error fetching data:", error);
        notify.error("Failed to load resident details");
